        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: '4dc2262d-362e-4c32-bc13-1f7725407270',
                name: data.name || '',
                email: data.email || '',
            ...
            // Don't break existing functionality - graceful degradation
          }
        })();
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ניצן פרשן משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
